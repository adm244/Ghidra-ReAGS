...
public class MyPcodeOpEmitter {
	...
	public MyPcodeOpEmitter(SleighLanguage language, Address opAddr, long uniqBase) {
		...
		opAddress = opAddr;
		seqnum = 0;
		spVarnode = findRegister("_farsp");
		defSpaceId = getConstant(defSpace.getSpaceID(), 4);
		farStackSpaceId = getConstant(farStackSpace.getSpaceID(), 4);
	}
	...
	private boolean compareVarnode(Varnode vn1, Varnode vn2, MyPcodeOpEmitter op2) {
		if (vn1 == null) {
			return (vn2 == null);
		}
		if (vn2 == null) {
	...
	public boolean equals(Object obj) {
		MyPcodeOpEmitter op2 = (MyPcodeOpEmitter) obj;
